...
Vagrant.configure(2) do |config|
  ...
  # documentation for more information about their specific syntax and use.
   config.vm.provision "shell", inline: <<-SHELL
     ...
     #sudo git clone https://github.com/opscode-cookbooks/tomcat /vagrant/cookbooks/tomcat
     #sudo git clone https://github.com/opscode-cookbooks/java /vagrant/cookbooks/java
